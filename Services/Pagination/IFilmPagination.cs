...
namespace FilmsCatalogTestTask.Services.Pagination
{
    public interface IFilmPagination
    {
        ...
        Task<FilmPagination> GetFilmsPage(int pageNumber, int? sizePage, string? orderBy = null, string? filterByDate = null, int? filterByCategory = null, string? filterByDirector = null);
    }
}